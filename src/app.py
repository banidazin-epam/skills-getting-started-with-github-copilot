...
activities = {
    ...
    "Swimming Practice": {
        "description": "Swim laps and improve technique with the swim team",
    ...
    "Robotics Club": {
        "description": "Design and build robots for competitions and showcases",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 14,
        "participants": ["zara@mergington.edu", "ben@mergington.edu"]
    }
}
